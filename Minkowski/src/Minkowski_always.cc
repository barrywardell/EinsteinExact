...
static void Minkowski_always_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const imin[3], int const imax[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
    ...
    CCTK_REAL_VEC_SIZE)
  {
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED G11 = ToReal(1);
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp6 = kmul(Jac11,Jac11);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp7 = kmul(Jac21,Jac21);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp8 = kmul(Jac31,Jac31);
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp9 = kmul(Jac12,Jac12);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp10 = kmul(Jac22,Jac22);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp11 = kmul(Jac32,Jac32);
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp12 = kmul(Jac13,Jac13);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp13 = kmul(Jac23,Jac23);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp14 = kmul(Jac33,Jac33);
  ...
  LC_ENDLOOP3VEC(Minkowski_always);
}
