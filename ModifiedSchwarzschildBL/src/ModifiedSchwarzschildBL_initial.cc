...
static void ModifiedSchwarzschildBL_initial_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const imin[3], int const imax[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
    ...
    CCTK_REAL_VEC_SIZE)
  {
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED rXYZ = 
      ksqrt(kmadd(X,X,kmadd(Y,Y,kmul(Z,Z))));
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp9 = ToReal(0.5*M);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp10 = kdiv(ToReal(1),rXYZ);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp11 = ToReal(ScalarINV(M));
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp12 = ToReal(ScalarSQR(M));
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp13 = 
      ToReal(ScalarINV(ScalarSQR(Pi)));
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED K11 = ToReal(0);
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED alpp = ToReal(1);
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp14 = kmul(Jac11,Jac11);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp15 = kmul(Jac21,Jac21);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp16 = kmul(Jac31,Jac31);
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp17 = kmul(Jac12,Jac12);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp18 = kmul(Jac22,Jac22);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp19 = kmul(Jac32,Jac32);
    ...
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp20 = kmul(Jac13,Jac13);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp21 = kmul(Jac23,Jac23);
    
    CCTK_REAL_VEC CCTK_ATTRIBUTE_UNUSED csetemp22 = kmul(Jac33,Jac33);
  ...
  LC_ENDLOOP3VEC(ModifiedSchwarzschildBL_initial);
}
