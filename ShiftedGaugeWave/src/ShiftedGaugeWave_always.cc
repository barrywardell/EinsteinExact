...
static void ShiftedGaugeWave_always_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const imin[3], int const imax[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  LC_LOOP3VEC(ShiftedGaugeWave_always,
    ...
    CCTK_REAL_VEC_SIZE)
  {
    ...
    CCTK_REAL_VEC csetemp7 = INV(ToReal(period));
    
    alpL = 
      INV(ksqrt(kmadd(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),ToReal(amp),ToReal(1))));
    
    CCTK_REAL_VEC dtalpL = 
      kmul(csetemp7,kmul(kcos(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),kmul(kpow(kmadd(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),ToReal(amp),ToReal(1)),-1.5),kmul(ToReal(amp),ToReal(Pi)))));
    
    CCTK_REAL_VEC G11 = 
      kmadd(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),ToReal(amp),ToReal(1));
    ...
    CCTK_REAL_VEC K11 = 
      kneg(kmul(kcos(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),kmul(INV(kmul(alpL,kmadd(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),kmul(ToReal(amp),ToReal(period)),ToReal(period)))),kmul(ToReal(amp),ToReal(Pi)))));
    ...
    CCTK_REAL_VEC betap1 = 
      kneg(kmul(INV(kmadd(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),ToReal(amp),ToReal(1))),kmul(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),ToReal(amp))));
    ...
    CCTK_REAL_VEC dtbetap1 = 
      kmul(csetemp7,kmul(kcos(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),kmul(INV(SQR(kmadd(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),ToReal(amp),ToReal(1)))),kmul(ToReal(2),kmul(ToReal(amp),ToReal(Pi))))));
    
    CCTK_REAL_VEC dtbetap2 = ToReal(0);
    
    CCTK_REAL_VEC dtbetap3 = ToReal(0);
    
    CCTK_REAL_VEC csetemp8 = SQR(Jac11);
    
    CCTK_REAL_VEC csetemp9 = SQR(Jac21);
    
    CCTK_REAL_VEC csetemp10 = SQR(Jac31);
    ...
    CCTK_REAL_VEC csetemp11 = SQR(Jac12);
    
    CCTK_REAL_VEC csetemp12 = SQR(Jac22);
    
    CCTK_REAL_VEC csetemp13 = SQR(Jac32);
    ...
    CCTK_REAL_VEC csetemp14 = SQR(Jac13);
    
    CCTK_REAL_VEC csetemp15 = SQR(Jac23);
    
    CCTK_REAL_VEC csetemp16 = SQR(Jac33);
  ...
  LC_ENDLOOP3VEC(ShiftedGaugeWave_always);
}
