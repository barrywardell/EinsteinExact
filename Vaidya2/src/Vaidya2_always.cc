...
static void Vaidya2_always_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const imin[3], int const imax[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL csetemp14 = INV(QAD(rXYZ));
    
    CCTK_REAL csetemp15 = CUB(rXYZ);
    
    CCTK_REAL csetemp16 = pow(rXYZ,5);
    
    CCTK_REAL csetemp17 = SQR(mTXYZ);
    
    CCTK_REAL csetemp18 = QAD(rXYZ);
    
    CCTK_REAL csetemp19 = rXYZ + T;
    
    CCTK_REAL K11 = -2*csetemp13*csetemp14*INV(sqrt(csetemp13*(csetemp15 + 
      2*(csetemp10 + csetemp11 + csetemp9)*mTXYZ)))*(-((csetemp16 - 
      2*csetemp15*csetemp9)*mTXYZ) + csetemp9*(csetemp17*(csetemp10 + 
      csetemp11 + csetemp9) - 
      csetemp18*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM)));
    
    CCTK_REAL K21 = 
      -2*csetemp13*csetemp14*X*Y*INV(sqrt(csetemp13*(csetemp15 + 2*(csetemp10 
      + csetemp11 + csetemp9)*mTXYZ)))*(csetemp17*(csetemp10 + csetemp11 + 
      csetemp9) + 2*csetemp15*mTXYZ - 
      csetemp18*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM));
    
    CCTK_REAL K31 = 
      -2*csetemp13*csetemp14*X*Z*INV(sqrt(csetemp13*(csetemp15 + 2*(csetemp10 
      + csetemp11 + csetemp9)*mTXYZ)))*(csetemp17*(csetemp10 + csetemp11 + 
      csetemp9) + 2*csetemp15*mTXYZ - 
      csetemp18*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM));
    
    CCTK_REAL K22 = -2*csetemp13*csetemp14*INV(sqrt(csetemp13*(csetemp15 + 
      2*(csetemp10 + csetemp11 + csetemp9)*mTXYZ)))*((2*csetemp10*csetemp15 - 
      csetemp16)*mTXYZ + csetemp10*(csetemp17*(csetemp10 + csetemp11 + 
      csetemp9) - 
      csetemp18*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM)));
    
    CCTK_REAL K32 = 
      -2*csetemp13*csetemp14*Y*Z*INV(sqrt(csetemp13*(csetemp15 + 2*(csetemp10 
      + csetemp11 + csetemp9)*mTXYZ)))*(csetemp17*(csetemp10 + csetemp11 + 
      csetemp9) + 2*csetemp15*mTXYZ - 
      csetemp18*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM));
    
    CCTK_REAL K33 = -2*csetemp13*csetemp14*INV(sqrt(csetemp13*(csetemp15 + 
      2*(csetemp10 + csetemp11 + csetemp9)*mTXYZ)))*((2*csetemp11*csetemp15 - 
      csetemp16)*mTXYZ + csetemp11*(csetemp17*(csetemp10 + csetemp11 + 
      csetemp9) - 
      csetemp18*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM)));
    
    CCTK_REAL alpp = INV(sqrt(csetemp13*(csetemp15 + 2*(csetemp10 + 
      csetemp11 + csetemp9)*mTXYZ)));
    
    CCTK_REAL dtalpp = -2*csetemp13*(csetemp10 + csetemp11 + 
      csetemp9)*pow(csetemp13*(csetemp15 + 2*(csetemp10 + csetemp11 + 
      csetemp9)*mTXYZ),-1.5)*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM);
    
    CCTK_REAL betap1 = 2*mTXYZ*rXYZ*X*INV(csetemp15 + 2*(csetemp10 + 
      csetemp11 + csetemp9)*mTXYZ);
    
    CCTK_REAL betap2 = 2*mTXYZ*rXYZ*Y*INV(csetemp15 + 2*(csetemp10 + 
      csetemp11 + csetemp9)*mTXYZ);
    
    CCTK_REAL betap3 = 2*mTXYZ*rXYZ*Z*INV(csetemp15 + 2*(csetemp10 + 
      csetemp11 + csetemp9)*mTXYZ);
    
    CCTK_REAL dtbetap1 = 4*csetemp18*X*INV(SQR(csetemp15 + 2*(csetemp10 + 
      csetemp11 + 
      csetemp9)*mTXYZ))*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM);
    
    CCTK_REAL dtbetap2 = 4*csetemp18*Y*INV(SQR(csetemp15 + 2*(csetemp10 + 
      csetemp11 + 
      csetemp9)*mTXYZ))*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM);
    
    CCTK_REAL dtbetap3 = 4*csetemp18*Z*INV(SQR(csetemp15 + 2*(csetemp10 + 
      csetemp11 + 
      csetemp9)*mTXYZ))*SQR(INV(cosh(csetemp12*csetemp19*ToReal(dM))))*tanh(csetemp12*csetemp19*ToReal(dM))*ToReal(dM);
    
    CCTK_REAL csetemp20 = SQR(Jac11);
    
    CCTK_REAL csetemp21 = SQR(Jac21);
    
    CCTK_REAL csetemp22 = SQR(Jac31);
    
    CCTK_REAL gxxL = csetemp20*G11 + csetemp21*G22 + csetemp22*G33 + 
    ...
    CCTK_REAL csetemp23 = SQR(Jac12);
    
    CCTK_REAL csetemp24 = SQR(Jac22);
    
    CCTK_REAL csetemp25 = SQR(Jac32);
    
    CCTK_REAL gyyL = csetemp23*G11 + csetemp24*G22 + csetemp25*G33 + 
    ...
    CCTK_REAL csetemp26 = SQR(Jac13);
    
    CCTK_REAL csetemp27 = SQR(Jac23);
    
    CCTK_REAL csetemp28 = SQR(Jac33);
    
    CCTK_REAL gzzL = csetemp26*G11 + csetemp27*G22 + csetemp28*G33 + 
      2*(G32*Jac23*Jac33 + Jac13*(G21*Jac23 + G31*Jac33));
    
    CCTK_REAL kxxL = csetemp20*K11 + csetemp21*K22 + 2*(Jac11*(Jac21*K21 + 
      Jac31*K31) + Jac21*Jac31*K32) + csetemp22*K33;
    ...
    CCTK_REAL kyyL = csetemp23*K11 + csetemp24*K22 + 2*(Jac12*(Jac22*K21 + 
      Jac32*K31) + Jac22*Jac32*K32) + csetemp25*K33;
    
    CCTK_REAL kyzL = Jac12*(Jac13*K11 + Jac23*K21 + Jac33*K31) + 
      Jac22*(Jac13*K21 + Jac23*K22 + Jac33*K32) + Jac32*(Jac13*K31 + 
      Jac23*K32 + Jac33*K33);
    
    CCTK_REAL kzzL = csetemp26*K11 + csetemp27*K22 + 2*(Jac13*(Jac23*K21 + 
      Jac33*K31) + Jac23*Jac33*K32) + csetemp28*K33;
