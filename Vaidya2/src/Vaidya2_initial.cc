...
static void Vaidya2_initial_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL csetemp233 CCTK_ATTRIBUTE_UNUSED = pow(gxzL,2);
    
    CCTK_REAL csetemp234 CCTK_ATTRIBUTE_UNUSED = pow(gyzL,2);
    
    CCTK_REAL csetemp235 CCTK_ATTRIBUTE_UNUSED = pow(gxyL,2);
    ...
    CCTK_REAL csetemp305 CCTK_ATTRIBUTE_UNUSED = pow(alpL,-1);
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_Vaidya2_initial
  DECLARE_CCTK_ARGUMENTS_CHECKED(Vaidya2_initial);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  const char* const groups[] = {
    ...
    "admbase::shift",
    "grid::coordinates"};
  AssertGroupStorage(cctkGH, "Vaidya2_initial", 7, groups);
  
  
  LoopOverEverything(cctkGH, Vaidya2_initial_Body);
  if (verbose > 1)
  {
