...
{\bf Parameters:} \code{M}, \code{a}, \code{epsilon} \\
{\bf Metric:} \\
\begin{equation}
g_{ab} =
\left(
...
where
\begin{equation}
r(x,y,z)=\max \left(\frac{\sqrt{\sqrt{\left(-a^2+x^2+y^2+z^2\right)^2+4 a^2 \
z^2}-a^2+x^2+y^2+z^2}}{\sqrt{2}},\frac{3 \epsilon ^2 \
\left(\sqrt{\left(-a^2+x^2+y^2+z^2\right)^2+4 a^2 \
z^2}-a^2+x^2+y^2+z^2\right)-\frac{1}{4} \
\left(\sqrt{\left(-a^2+x^2+y^2+z^2\right)^2+4 a^2 \
z^2}-a^2+x^2+y^2+z^2\right)^2+3 \epsilon ^4}{8 \epsilon ^3}\right)
\end{equation}
