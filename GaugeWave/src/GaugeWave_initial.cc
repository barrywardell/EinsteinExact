...
static void GaugeWave_initial_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const imin[3], int const imax[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
    ...
    CCTK_REAL_VEC_SIZE)
  {
    ...
    alpL = 
      INV(ksqrt(INV(knmsub(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),ToReal(amp),ToReal(1)))));
    
    CCTK_REAL_VEC dtalpL = 
      kmul(csetemp7,kmul(kcos(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),kmul(ksqrt(INV(knmsub(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),ToReal(amp),ToReal(1)))),kmul(ToReal(amp),ToReal(Pi)))));
    
    CCTK_REAL_VEC G11 = 
      knmsub(ksin(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),ToReal(amp),ToReal(1));
    ...
    CCTK_REAL_VEC K11 = 
      kneg(kmul(csetemp7,kmul(kcos(kmul(csetemp6,kmul(csetemp7,kmul(ToReal(2),ToReal(Pi))))),kmul(INV(alpL),kmul(ToReal(amp),ToReal(Pi))))));
